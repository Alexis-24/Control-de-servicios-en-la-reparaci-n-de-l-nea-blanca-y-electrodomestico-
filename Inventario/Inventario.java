...
private ResultSet rs;
        ...
        this.setLocationRelativeTo(null); //Poner el form en el centro
         ...
         Jengi.getSelectionModel().addListSelectionListener(new ListSelectionListener(){
                ...
                if(Jengi.getSelectedRow() != -1)
            {
                ...
                jTextField_modelo.setText(Jengi.getValueAt(fila, 1).toString());
                jTextField_marca.setText(Jengi.getValueAt(fila, 2).toString());
                jTextField_falla.setText(Jengi.getValueAt(fila, 3).toString());
                jTextField_estado.setText(Jengi.getValueAt(fila, 4).toString());
                jTextField_garantia.setText(Jengi.getValueAt(fila, 5).toString());
    ...
    void Mostrardatos(){
        QueryTableBusqueda("SELECT idequipo, modelo, marca, falla, estado, garantia FROM public.inventario\n" +
"ORDER BY idequipo ASC;");
    ...
    private void initComponents() {
        ...
        Jengi.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Modelo", "Marca", "Falla", "Estado", "Garantia"
            }
        ) {
        ...
        jTextField_estado.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jTextField_falla, javax.swing.GroupLayout.DEFAULT_SIZE, 139, Short.MAX_VALUE))
                .addGap(65, 65, 65)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel3)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jTextField_estado, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel5)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextField_garantia, javax.swing.GroupLayout.PREFERRED_SIZE, 184, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
                    .addComponent(jTextField_falla, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(27, 27, 27)
       ...
       PreparedStatement cs;
        ...
        if(filaPulsada>=0){
            ...
            try{
                ...
                cs=Database.getConexion().prepareStatement("SELECT idequipo FROM inventario WHERE idequipo = "+dtm.getValueAt(filaPulsada,0)+";");
                System.out.println("SELECT idequipo FROM inventario WHERE idequipo = "+dtm.getValueAt(filaPulsada,0)+";");
    ...
    if(veryfiel()){  
        ...
        String SQL = ("UPDATE inventario"+
                      ...
                      " SET modelo='"+modelo+"', marca='"+marca+"', falla='"+falla+"', estado='"+estado+"',garantia='"+garantia+"'" +
                      " WHERE idequipo='"+id+"';");
        ...
        ResultSet rs;
            ...
            try{
                ...
                if(rs.next()){
                   ...
                   jTextField_modelo.setText(rs.getString(1));
                   jTextField_estado.setText(rs.getString(2));
                   jTextField_marca.setText(rs.getString(3));
                   jTextField_garantia.setText(rs.getString(4));
                   jTextField_falla.setText(rs.getString(5));
                    ;
    ...
    if(modelo.trim().equals("") || estado.trim().equals("") || marca.trim().equals("") || garantia.trim().equals("") ||
     falla.trim().equals("") )
    {
