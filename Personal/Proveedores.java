    ...
    public Proveedores() {
        ...
        Tecnicos.getSelectionModel().addListSelectionListener(new ListSelectionListener(){
                ...
                if(Tecnicos.getSelectedRow() != -1)
            {
                ...
                jTextField_correo.setText(Tecnicos.getValueAt(fila, 6).toString());
               }
            }
    });
    }
...
"WHERE tipo_personal = 'pro' " + "ORDER BY idpersonal ASC;");
    ...
    private void initComponents() {
        ...
        Tecnicos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nombre", "Apellidos", "RFC", "Dirección", "Teléfono", "Correo"
            }
        ));
    ...
    private void jButton_modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_modificarActionPerformed
        ...
        if(veryfiel()){
            ...
            String SQL = ("UPDATE personal"+
                ...
                " SET nombre='"+nomb+"', apellidos='"+apell+"', rfc='"+rfc+"', direccion='"+direccion+"', telefono='"+telefono+"', correo='"+correo+"'" +
                " WHERE idpersonal='"+id+"';");
